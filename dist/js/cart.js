...
/***/ (function(module, exports, __webpack_require__) {
	...
	var templateIndex   = __webpack_require__(23);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	__webpack_require__(8);  //导航栏样式 引进
	var _mm     = __webpack_require__(10);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Hogan = __webpack_require__(11);  //用hogan渲染html模板
	var conf = {
	    serverHost : ''
	};
	var _mm={
		...
		request:function(param){
			...
			$.ajax({
				...
				success : function(res){
					if(res.status===0){  //请求成功  回调param.success(res.data, res.msg)
	    ...
	    validate : function(value, type){
	        var value = $.trim(value);   //去除空格   如果value不是字符串 变为字符串
	        // 非空验证
	        if('require' === type){
	            return !!value;
	        }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _mm = __webpack_require__(10);
	var templatePagination  = __webpack_require__(20);
